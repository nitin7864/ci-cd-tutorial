...
export default class FilterSecComp extends LightningElement {
   ...
   handleCountryChange(event) {
        this.template.querySelector('c-list-view-sec-comp').handleCountryChange(event.target.value);
    ...
    handleStateChange(event) {
        this.template.querySelector('c-list-view-sec-comp').handleStateChange(event.target.value);
    }
}
